...
import { RolesController } from '../../lib/controllers/roles';


/**
 * Deactivated post/patch/delete for roles bacause in the current situation the roles are static scoped and users has thei own scope
 */
